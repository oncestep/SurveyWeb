(function (H) {
    ...
    var defaultOptionsZhCn = {
        lang: {
            ...
            decimalPoint: ".",
            downloadJPEG: "涓嬭浇JPEG鍥剧墖",
            downloadPDF: "涓嬭浇PDF鏂囦欢",
            downloadPNG: "涓嬭浇PNG鏂囦欢",
            downloadSVG: "涓嬭浇SVG鏂囦欢",
        ...
        rangeSelector: {
            ...
            buttons: [{type: "month", count: 1, text: "鏈�"}, {type: "month", count: 3, text: "瀛ｅ害"}, {
                type: "month",
                count: 6,
                text: "鍗婂勾"
            }, {type: "ytd", text: "YTD"}, {type: "year", count: 1, text: "骞�"}, {type: "all", text: "鎵€鏈�"}]
        },
        plotOptions: {
            series: {
                dataGrouping: {
